import 'package:agora/usersPage.dart';
...
class _MyHomePageState extends State<MyHomePage> {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("login userId: ${userId}"),
            const Text("agoraToken: ${token}"),
            const SizedBox(height: 10),
            Row(
  ...
  void _addChatListener() {
    ...
    ChatClient.getInstance.chatManager.addMessageEvent(
      ...
      ChatMessageEvent(
        onSuccess: (msgId, msg) {
          _addLogToConsole("send message: $_messageContent ,$_chatId,$msgId,$msg");
        },
  ...
  void _signIn() async {
    try {
      ...
      _addLogToConsole("login failed, code: ${e}, desc: ${e.description}");
    }
  }
