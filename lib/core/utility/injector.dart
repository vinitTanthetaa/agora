...
import 'package:agora/data/repositories_impl/calling_rooms_repo_impl.dart';
import 'package:agora/data/repositories_impl/firebase_auth_repository_impl.dart';
import 'package:agora/data/repositories_impl/firestore_notification.dart';
import 'package:agora/data/repositories_impl/firestore_story_repo_impl.dart';
import 'package:agora/data/repositories_impl/firestore_user_repo_impl.dart';
import 'package:agora/data/repositories_impl/group_message_repo_impl.dart';
import 'package:agora/data/repositories_impl/post/comment/firestore_comment_repo_impl.dart';
import 'package:agora/data/repositories_impl/post/comment/firestore_reply_repo_impl.dart';
import 'package:agora/data/repositories_impl/post/firestore_post_repo_impl.dart';
import 'package:agora/domain/repositories/auth_repository.dart';
...
import 'package:agora/domain/use_cases/auth/email_verification_usecase.dart';
import 'package:agora/domain/use_cases/auth/log_in_auth_usecase.dart';
import 'package:agora/domain/use_cases/auth/sign_out_auth_usecase.dart';
import 'package:agora/domain/use_cases/auth/sign_up_auth_usecase.dart';
import 'package:agora/domain/use_cases/calling_rooms/cancel_joining_to_room.dart';
import 'package:agora/domain/use_cases/calling_rooms/create_calling_room.dart';
import 'package:agora/domain/use_cases/calling_rooms/delete_the_room.dart';
import 'package:agora/domain/use_cases/calling_rooms/get_calling_status.dart';
import 'package:agora/domain/use_cases/calling_rooms/get_users_info_in_room.dart';
import 'package:agora/domain/use_cases/calling_rooms/join_to_calling_room.dart';
import 'package:agora/domain/use_cases/follow/follow_this_user.dart';
import 'package:agora/domain/use_cases/follow/remove_this_follower.dart';
import 'package:agora/domain/use_cases/message/common/get_specific_chat_info.dart';
import 'package:agora/domain/use_cases/message/group_message/add_message.dart';
import 'package:agora/domain/use_cases/message/group_message/delete_message.dart';
import 'package:agora/domain/use_cases/message/group_message/get_messages.dart';
import 'package:agora/domain/use_cases/message/single_message/add_message.dart';
import 'package:agora/domain/use_cases/message/single_message/delete_message.dart';
import 'package:agora/domain/use_cases/message/single_message/get_chat_users_info.dart';
import 'package:agora/domain/use_cases/message/single_message/get_messages.dart';
import 'package:agora/domain/use_cases/notification/create_notification_use_case.dart';
import 'package:agora/domain/use_cases/notification/delete_notification.dart';
import 'package:agora/domain/use_cases/notification/get_notifications_use_case.dart';
import 'package:agora/domain/use_cases/post/comments/add_comment_use_case.dart';
import 'package:agora/domain/use_cases/post/comments/getComment/get_all_comment.dart';
import 'package:agora/domain/use_cases/post/comments/put_like.dart';
import 'package:agora/domain/use_cases/post/comments/remove_like.dart';
import 'package:agora/domain/use_cases/post/comments/replies/get_replies_of_this_comment.dart';
import 'package:agora/domain/use_cases/post/comments/replies/likes/put_like_on_this_reply.dart';
import 'package:agora/domain/use_cases/post/comments/replies/likes/remove_like_on_this_reply.dart';
import 'package:agora/domain/use_cases/post/comments/replies/reply_on_this_comment.dart';
import 'package:agora/domain/use_cases/post/create_post.dart';
import 'package:agora/domain/use_cases/post/delete/delete_post.dart';
import 'package:agora/domain/use_cases/post/get/get_all_posts.dart';
import 'package:agora/domain/use_cases/post/get/get_post_info.dart';
import 'package:agora/domain/use_cases/post/get/get_specific_users_posts.dart';
import 'package:agora/domain/use_cases/post/likes/put_like_on_this_post.dart';
import 'package:agora/domain/use_cases/post/likes/remove_the_like_on_this_post.dart';
import 'package:agora/domain/use_cases/post/update/update_post.dart';
import 'package:agora/domain/use_cases/story/create_story.dart';
import 'package:agora/domain/use_cases/story/delete_story.dart';
import 'package:agora/domain/use_cases/story/get_specific_stories.dart';
import 'package:agora/domain/use_cases/story/get_stories_info.dart';
import 'package:agora/domain/use_cases/user/add_new_user_usecase.dart';
import 'package:agora/domain/use_cases/user/add_post_to_user.dart';
import 'package:agora/domain/use_cases/user/getUserInfo/get_all_un_followers_info.dart';
import 'package:agora/domain/use_cases/user/getUserInfo/get_all_users_info.dart';
import 'package:agora/domain/use_cases/user/getUserInfo/get_followers_and_followings_usecase.dart';
import 'package:agora/domain/use_cases/user/getUserInfo/get_specific_users_usecase.dart';
import 'package:agora/domain/use_cases/user/getUserInfo/get_user_from_user_name.dart';
import 'package:agora/domain/use_cases/user/getUserInfo/get_user_info_usecase.dart';
import 'package:agora/domain/use_cases/user/my_personal_info.dart';
import 'package:agora/domain/use_cases/user/search_about_user.dart';
import 'package:agora/domain/use_cases/user/update_user_info.dart';
import 'package:agora/domain/use_cases/user/upload_profile_image_usecase.dart';
import 'package:agora/presentation/cubit/StoryCubit/story_cubit.dart';
import 'package:agora/presentation/cubit/callingRooms/bloc/calling_status_bloc.dart';
import 'package:agora/presentation/cubit/callingRooms/calling_rooms_cubit.dart';
import 'package:agora/presentation/cubit/firebaseAuthCubit/firebase_auth_cubit.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/add_new_user_cubit.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/message/bloc/message_bloc.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/message/cubit/group_chat/message_for_group_chat_cubit.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/message/cubit/message_cubit.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/searchAboutUser/search_about_user_bloc.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/user_info_cubit.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/users_info_cubit.dart';
import 'package:agora/presentation/cubit/firestoreUserInfoCubit/users_info_reel_time/users_info_reel_time_bloc.dart';
import 'package:agora/presentation/cubit/follow/follow_cubit.dart';
import 'package:agora/presentation/cubit/notification/notification_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/commentsInfo/cubit/comment_likes/comment_likes_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/commentsInfo/cubit/comments_info_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/commentsInfo/cubit/repliesInfo/replyLikes/reply_likes_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/commentsInfo/cubit/repliesInfo/reply_info_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/postLikes/post_likes_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/post_cubit.dart';
import 'package:agora/presentation/cubit/postInfoCubit/specific_users_posts_cubit.dart';
